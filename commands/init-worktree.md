...
- `knowledge/operational-patterns/multi-agent/worktree-workflows.md` — Worktree deep dive
- `knowledge/operational-patterns/multi-agent/collaboration-patterns.md` — Parallel patterns
