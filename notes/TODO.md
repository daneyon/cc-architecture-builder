...
- [ ] **LL-25 follow-on: Pre-push hook regex refinement** — Current `\bWIP\b` regex produces false positives on descriptive prose. Tighten to require markers at line-start or as explicit labels (`WIP:`, `DRAFT:`, `// WIP`, etc.). Alternatively, use a more specific marker set that's unlikely to appear in normal prose.
