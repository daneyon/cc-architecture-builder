...
* **Process Mapping:** Workflow diagrams involve [mapping](https://sixsigmadsi.com/process-mapping-vs-flowchart-key-differences/) out the entire process, from the initiation to the completion of a task. Each step in the process is typically represented by a shape, and arrows indicate the direction of flow from one step to the next.
* **Types of Workflow Diagrams:** There are various types of workflow diagrams, each serving a specific purpose. Common types include process flowcharts, swimlane diagrams, SIPOC diagrams, and more. The choice of diagram depends on the complexity of the process and the [level](https://sixsigmadsi.com/glossary/level/) of detail required.
...
![What is a Detailed Process Map?](data:image/jpeg;base64...)What is a Detailed Process Map?

There are three main types of process flow diagrams, each serving a distinct purpose:

* **Process** [**Flowchart**](https://sixsigmadsi.com/glossary/flowchart/)**:** Provides a comprehensive view of the entire process, including inputs, outputs, and decision points.
* **Data Flow Diagram (DFD):** Focuses on the flow of data within a system, highlighting how information moves between processes.
* **System Flow Diagram:** Illustrates the [interaction](https://sixsigmadsi.com/glossary/interaction/) between various components within a system, showcasing how they work together.
